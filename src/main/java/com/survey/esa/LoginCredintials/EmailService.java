...
public class EmailService {
    ...
    public void sendActivationEmail(String toEmail, String userName) {
        ...
        String body = "<html>"
                ...
                + "<h1 style='color: white; font-size: 36px; margin: 0;'>Pulz Survey</h1>"
                ...
                + "<a href='https://pulse.meinigar.online/login' style='background-color: #4CAF50; color: white; padding: 12px 25px; text-decoration: none; font-size: 16px; border-radius: 5px;'>Login to Pulse Survey</a>"
                + "</div>"
